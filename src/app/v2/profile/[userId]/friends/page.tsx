...
// Alphabetical with search. Linked from friend profile > Friends.

import { use, useState } from 'react'
import Link from 'next/link'
import { useRouter } from 'next/navigation'
import { STUB_FRIENDS, STUB_FRIENDS as ALL_FRIENDS } from '@/lib/v2/stub-data'

export default function FriendFriendsPage({ params }: { params: Promise<{ userId: string }> }) {
  ...
  // STUB: show same friends list for all users
  const sorted = [...ALL_FRIENDS].sort((a, b) => a.name.localeCompare(b.name))
